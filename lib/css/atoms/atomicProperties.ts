...
const boxShadow = {
  ...
  // Deprecated
  borderFormHover: `inset 0 0 0 ${vars.borderWidth.standard} ${vars.borderColor.formAccent}`,
  borderStandard: `inset 0 0 0 ${vars.borderWidth.standard} ${vars.borderColor.neutralLight}`,
  borderStandardInverted: `inset 0 0 0 ${vars.borderWidth.standard} ${vars.borderColor.neutralInverted}`,
  borderStandardInvertedLarge: `inset 0 0 0 ${vars.borderWidth.large} ${vars.borderColor.neutralInverted}`,
};
